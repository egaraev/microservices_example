...
LOGMONGO_IP = SELF_IP
LOGMONGO_PORT = '5000'
REGISTRY = ':'.join([LOGMONGO_IP, LOGMONGO_PORT])
c.kv.put('logmongo', REGISTRY)
...
#Usage
# Adding items
# curl -d '{"id": 1, "desc": "item1", "date": "value1"}' -H "Content-Type: application/json" -X POST http://localhost:5000/api/v1/items
# Editing items
#  curl -d '{"$set": {"id": 1, "desc": "New name"}}' -H "Content-Type: application/json" -X POST http://localhost:5000/api/v1/items/1 
# Deleting items
